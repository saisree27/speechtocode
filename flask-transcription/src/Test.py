...
import Interpreter
language = 'java'
statements = ["create a public type function called prime returning an int with 2 parameters of type int called x and type boolean called y", "create a for loop from 1 to x incrementing by 1", "if x mod i equals to 0", "return false", "return true", "print a call to function prime with parameters 10 false"]
