...
statements = ["create a public function fibonacci returning int with 1 paramter number", "if number is lesser than equals to 1", "return number", "return a call to function called factorial with parameter number minus 1 finish plus a call to a function factorial with a parameter called number minus 2 finish"]
for i in statements:
