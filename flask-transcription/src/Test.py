...
statements = ["create a public function factorial returning int with 1 parameter of type int called number", "assign y to 1", "create a for loop from 1 to x with increment 1", "assign y to y times i", "return y", "if number equals 1 or number equals 2", "return a call to function factorial with parameter number minus 1 plus a call to function factorial with parameter number minus 2"]
