    ...
    <div>
      <div id='bg'>
        ...
        <div className="topnav">
          <a className="active fw-light font-monospace" href="/">HOME</a>
          <a className="active fw-light font-monospace" href="/learn">SPEECH2CODE</a>
          <a className="active fw-light font-monospace" href="/tutorial">TUTORIAL</a>
        </div>
        ...
        <Link to="/learn"><button id = 'startButton' className="me-5 btn btn-info fw-light font-monospace"> Use the Tool</button></Link>
        <Link to="/tutorial"><button id = 'tutorialButton' className="ms-2 btn btn-secondary fw-light font-monospace">Follow Tutorial</button></Link>
        </center>
