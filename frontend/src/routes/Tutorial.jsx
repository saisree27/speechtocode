    ...
    <div>
      ...
      <div className="tutorialblock">
        ...
        <p>
          ...
          their program's logic. In most languages, they're often described with
          'if' or 'else'.
        </p>
        <p>
          The 'if' statement takes in a boolean (or true/false) expression that
          is evaluated, and if the result is true, then the program runs inside
          the statement.
        </p>
        <p>
          The 'else' statement always comes after an 'if' statement, executing
          only if that boolean expression results in false and running whatever
          is inside it instead.
        </p>
        <br />
        <p>
          <strong>Control flow</strong> allows programmers to direct the flow of
          their program to repeat certain instructions for set conditions or
          limits. A classic example of this is
        </p>
        <p>
          the 'while' loop, which takes in a boolean expression that is
          evaluated, and if the result is true, then the program runs inside the
          statement until it's false.
        </p>
        <p>
          Alternatively, the 'for' loop initializes a counter and increments it
          by a set number until its boolean expression for this counter returns
          false.
        </p>
        <p>
      ...
      <div className="tutorialblock">
        ...
        <p>
          For example, if you want to see if an integer x is divisible by 10 and
          return true, you'd say: "
      ...
      <div className="tutorialblock">
        ...
        <p>
          ...
          <strong>
            create a for loop from [counter's start number] to [end number] with
            increment [number]
          </strong>
          ."
        </p>
        <p>
          For example, if you want to print the number 10 five times, you'd say:
          "
          <strong>
